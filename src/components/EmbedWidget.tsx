  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 12 }}>
        <label style={{ fontSize: '0.75rem', color: 'var(--text-muted)', display: 'flex', alignItems: 'center', gap: 6 }}>
          Slide interval:
          <select
            value={interval}
            ...
            style={{
              ...
              borderRadius: 6, color: 'var(--text-secondary)', padding: '3px 8px', fontSize: '0.75rem',
            }}
          >
            {[3, 5, 7, 10, 15].map(n => (
      ...
      <div style={{
        background: 'var(--midnight)', border: '1px solid var(--midnight-border)',
        borderRadius: 8, padding: 12, fontSize: '0.65rem', fontFamily: 'var(--font-mono)',
