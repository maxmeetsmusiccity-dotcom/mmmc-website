...
export interface TitleSlideTemplate {
  ...
  // Layout (fractions 0-1, default 0.5 = centered)
  headlineX: number;
  headlineY: number;
  subtitleX: number;
  subtitleY: number;
...
const LEGACY_TITLE_TEMPLATES: TitleSlideTemplate[] = [
  // 1. Nashville Neon
  {
    ...
    subtitleSize: 0.028,
    dateSize: 0.042,
    headlineX: 0.5, headlineY: 0.04,
    subtitleX: 0.5, subtitleY: 0.12,
    dateX: 0.5, dateY: 0.90,
    featuredImageX: 0.5, featuredImageY: 0.18,
  ...
  // 2. Vintage Press
  {
    ...
    dateSize: 0.038,
    headlineX: 0.5, headlineY: 0.04,
    subtitleX: 0.5, subtitleY: 0.11,
    dateX: 0.5, dateY: 0.91,
    featuredImageX: 0.5, featuredImageY: 0.17,
  ...
  // 4. Studio Clean
  {
    ...
    subtitleSize: 0.022,
    dateSize: 0.030,
    headlineX: 0.5, headlineY: 0.05,
    subtitleX: 0.5, subtitleY: 0.11,
    dateX: 0.5, dateY: 0.92,
    featuredImageX: 0.5, featuredImageY: 0.18,
  ...
  // 8. Saturated Block
  {
    ...
    dateSize: 0.038,
    headlineX: 0.5, headlineY: 0.03,
    subtitleX: 0.5, subtitleY: 0.13,
    dateX: 0.5, dateY: 0.90,
    featuredImageX: 0.5, featuredImageY: 0.19,
  ...
  // 11. Gold Frame — minimal luxury, thin gold inset border, clean editorial
  {
    ...
    subtitleSize: 0.022,
    dateSize: 0.032,
    headlineX: 0.5, headlineY: 0.06,
    subtitleX: 0.5, subtitleY: 0.11,
    dateX: 0.5, dateY: 0.90,
    featuredImageX: 0.5, featuredImageY: 0.22,
    featuredImageSize: 0.50,
    glow: { color: 'rgba(212,168,67,0.1)', blur: 8, passes: 1 },
    grain: 0.08,
    vignette: 0.20,
    showFrame: true, frameColor: '#F5C453', frameWidth: 3,
  ...
  // 12. Spotlight — radial gradient, floating album art, modern/technical feel
  {
    ...
    dateSize: 0.028,
    headlineX: 0.5, headlineY: 0.05,
    subtitleX: 0.5, subtitleY: 0.10,
    dateX: 0.5, dateY: 0.91,
    featuredImageX: 0.5, featuredImageY: 0.24,
    featuredImageSize: 0.48,
  ...
  // 14. Vinyl Classic — Max's original cover slide: vinyl record + gold neon
  {
    ...
    subtitleX: 0.5, subtitleY: 0.10,
    dateX: 0.5, dateY: 0.90,
    featuredImageX: 0.5, featuredImageY: 0.28,
