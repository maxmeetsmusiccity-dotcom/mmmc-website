...
export const TITLE_TEMPLATES: TitleSlideTemplate[] = [
  ...
  // 3. Dust & Gold
  {
    id: 'dust_gold',
    name: 'Dust & Gold',
    description: 'Warm sienna & gold — classic country warmth',
    background: '#1C1208',
    backgroundGradient: 'linear-gradient(180deg, #2A1C0F 0%, #1C1208 50%, #0F0A04 100%)',
    textPrimary: '#FFD700',
    ...
    featuredImageY: 0.18,
    featuredImageSize: 0.52,
    glow: { color: 'rgba(255,215,0,0.3)', blur: 45, passes: 4 },
    grain: 0.20,
    vignette: 0.30,
    showFrame: false, frameColor: '', frameWidth: 0,
    showDivider: true, dividerColor: 'rgba(255,179,71,0.4)',
    featuredBorder: 12, featuredBorderColor: '#FFF5E0', featuredShadowBlur: 30, featuredRotation: 0,
    texture: 'grain',
    swipePill: true,
  },
